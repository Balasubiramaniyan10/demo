...
<%
	...
	Webpage webpage=new Webpage(url,null,postdata,false,true);
...
%>Search results:<table><%
	...
	Wine[] Winesfound = TableScraper.ScrapeWine(Page, Integer.parseInt(shopid), url, urlregex, "Shopurl",spider.getBaseUrl(), headerregex, tablescraper, winesep, fieldsep, filter, nameorder, nameregex, nameexclpattern,
		vintageorder, vintageregex, priceorder, priceregex, sizeorder, sizeregex, null,1.0,1.0,TableScraper.getRatingScraper(Integer.parseInt(shopid)),false);
