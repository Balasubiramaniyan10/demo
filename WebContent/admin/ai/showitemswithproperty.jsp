...
<script type="text/javascript">
var disorenable = '/admin/ai/updatekbknownwine.jsp?id=';
...
<form action='showitemswithproperty.jsp'>
Propertyid<br/>
...
<%	
int propertyid=0;
try{propertyid=Integer.parseInt(request.getParameter("propertyid"));}catch(Exception e){}
Context c=new Context(request);
AiHtmlRefiner r=new AiHtmlRefiner(c.tenant,new Recognizer("name","itemid","wineid","aiwines",1,true));
out.print(r.showitemswithproperty(propertyid));
%>
</body> 
</html>