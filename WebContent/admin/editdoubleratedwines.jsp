...
<br><a href='taskrunner.jsp?task=analyseRatedWines' target='_blank'>Start Batch job to Analyze rated wines</a>
	<form id="theform" name="theform" action='editdoubleratedwines.jsp' method='POST'>
...
<%	
out.print(Knownwines.editDoubleRatedWinesHTML(appellation));
%>
</body> 
</html>