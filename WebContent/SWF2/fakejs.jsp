...
var d=""+(document.cookie.match(/JSESSIONID=[^;]+/));
var f = new Date();
var n=f.getHours() + ":"  + f.getMinutes() + ":" + f.getSeconds();
//var c=hash(base64_encode(n));
//var h=hash(base64_encode(d));
//alert(base64_encode(""+(c+h)));

var hashObj=new jsSHA(d+n, "TEXT");
