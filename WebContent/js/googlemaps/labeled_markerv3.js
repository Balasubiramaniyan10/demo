...
function LabeledMarker(latlng, options){
    ...
    this.labelOffset = options.labelOffset || new GSize(-0.5*this.labelText.length, -10);
...
////v3LabeledMarker.prototype = new GMarker(new GLatLng(0, 0));
...
LabeledMarker.prototype.redraw = function(force) {
	...
	//var p = this.map.fromLatLngToDivPixel(this.latlng); JH: removed and changed to make it draggable
