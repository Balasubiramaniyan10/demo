...
<TABLE class="logo" BORDER="0" CELLSPACING="0" WIDTH="600" HEIGHT="120" >
   ...
   <TR><a href='<%= response.encodeURL("/")%>' ><TD WIDTH="80" HEIGHT="40" ></TD></a><TD><a href="/">Home</a><br/></TD><TD><a href="/settings/index.jsp">Notifications</a><br/></TD><TD><a href="/about.jsp">About us</a><br/></TD><TD><a href="/sponsoring.jsp">Sponsoring</a><br/></TD><TD><a href="/contact.jsp">Contact</a><br/></TD><TD><a href="/disclaimer.jsp">Disclaimer</a></TD><TD><% if (request.getRemoteUser()!=null) {%><a href="<%=response.encodeURL("/logout.jsp") %>">Log out</a><br/><%}%></TD><TD></TD></TR></a>
   </TD></TR></TABLE>
