...
public class Steganography
{
	...
	public BufferedImage getStegoImage(String filename, String message)
	{
	...
	private BufferedImage add_text(BufferedImage image, String text)
	{
		...
		try
		{
			...
			//Dbutil.logger.info(img[0]&1);
			//Dbutil.logger.info(img[1]&1);
			//Dbutil.logger.info(img[2]&1);
			//Dbutil.logger.info(img[3]&1);
		}
		catch(Exception e)
		{
			Dbutil.logger.info("Target File cannot hold message!");
		}
		return image;
	}
	...
	{
		Dbutil.logger.info(image[0]&1);
		Dbutil.logger.info(image[1]&1);
		Dbutil.logger.info(image[2]&1);
		Dbutil.logger.info(image[3]&1);
		int length = 0;
		int offset  = 32;
	...
	public static void main(String[] args){
		...
		System.out.println(s.decode("C:\\workspace", "download"));
	}
}
